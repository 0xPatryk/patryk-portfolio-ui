      ...
      <div className="container mx-auto px-4 md:px-6 z-10">
        <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12">
          <div className="md:w-3/5 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-4 opacity-0 translate-y-8 animate-slide-up" style={{ animationDelay: '0.4s' }}>
              Hi, I'm Patryk. I transform business challenges into elegant software solutions that deliver real value.
            </p>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 opacity-0 translate-y-8 animate-slide-up" style={{ animationDelay: '0.5s' }}>
